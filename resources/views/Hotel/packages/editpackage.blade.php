                    ...
                    <form action="{{ route('hotelpackages.update', $package->id) }}" method="POST">
                        ...
                        <div>
                            ...
                            <div class="mb-4">
                                ...
                                <select name="status"
                                    class="w-1/2 border border-gray-300 rounded-md px-3 py-2 text-sm cursor-pointer">
                        ...
                        <button
                            class="bg-slate-700 hover:bg-slate-500 w-1/2 cursor-pointer text-sm rounded-md px-5 py-2 mt-4 text-white">Update</button>
                </div>
                </form>
            </div>
        </div>
