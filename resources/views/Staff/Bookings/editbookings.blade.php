        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="{{ route('staffbookings.update', $booking->id) }}" method="post">
                        @csrf
                        <div>
                            ...
                            <button
                                class="bg-slate-700 hover:bg-slate-500 cursor-pointer text-sm rounded-md px-5 py-2 w-full text-white">Update</button>
                        </div>
                </div>
                </form>
            </div>
