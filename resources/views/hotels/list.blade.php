             ...
             <table class="w-full">
                <thead class="bg-gray-50">
                    <tr class="border-b">
                        ...
                        {{-- <th class="px-6 py-2 rounded-md text-left">Hotel owner</th> --}}
                ...
                <tbody class="bg-white">
                    ...
                    <tr class="border-b">
                        <td class="px-6 py-2 text-left w-10">{{$hotels->firstItem()+$idx}}</td>
                        <td class="px-6 py-2 text-left ">{{$hotel->name}}</td>
                        {{-- <td class="px-6 py-2 text-left ">{{$hotel->name}}</td> --}}
                        <td  class="px-6 py-2 text-left">{{$hotel->email}}</td>
